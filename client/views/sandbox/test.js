...
// 	},
// 	{
// 		dateCreated: "01/22/2015",
// 		score: 88.8
// 	},
// 	{
// 		dateCreated: "02/08/2015",
// 		score: 100.0
// 	},
// 	{
// 		dateCreated: "02/22/2015",
// 		score: 50.0
// 	}
// ];
...
// var calculateTestAverages = function (testResults, startDate, endDate) {
//   var output = [];
//   var getDate = function (d) {
//     return new Date(d.split('/') [2], d.split('/') [0], d.split('/') [1]);
//   };
//   var dateFilteredTestResults = testResults.filter(function (el) {
//     return getDate(el.dateCreated) .getTime() > getDate(startDate) .getTime() && getDate(el.dateCreated) .getTime() < getDate(endDate) .getTime();
//   });
//   for (var year = getDate(startDate) .getYear(); year <= getDate(endDate) .getYear(); year += 1) {
//     for (var month = getDate(startDate) .getMonth(); month <= getDate(endDate) .getMonth(); month += 1) {
//       var forMonthResults = dateFilteredTestResults.filter(function (el) {
//         return getDate(el.dateCreated) .getMonth() === month && getDate(el.dateCreated) .getYear() === year;
//       });
//       if (forMonthResults.length > 0) {
//         output.push(forMonthResults.reduce(function (p, c) {
//           return p + c.score;
//         }, 0) / forMonthResults.length);
//       } else {
//         output.push(0);
//       }
//     }
